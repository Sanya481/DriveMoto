...
/***/ "./src/js/appear-delete-btn-input.js":
/*!*******************************************!*\
  !*** ./src/js/appear-delete-btn-input.js ***!
  \*******************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/js/description-issue-modal.js":
/*!*******************************************!*\
  !*** ./src/js/description-issue-modal.js ***!
  \*******************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/js/good-availability-modal.js":
/*!*******************************************!*\
  !*** ./src/js/good-availability-modal.js ***!
  \*******************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "onOpenNotificationGoodAvailability": () => (/* binding */ onOpenNotificationGoodAvailability)
/* harmony export */ });
const body = document.body;
...
/* harmony import */ var _vendor_wNumb_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./vendor/wNumb.js */ "./src/js/vendor/wNumb.js");
/* harmony import */ var _vendor_imask_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./vendor/imask.js */ "./src/js/vendor/imask.js");
...
/***/ "./src/js/product-checkout-map.js":
/*!****************************************!*\
  !*** ./src/js/product-checkout-map.js ***!
  \****************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/js/rendering-goods-to-basket.js":
/*!*********************************************!*\
  !*** ./src/js/rendering-goods-to-basket.js ***!
  \*********************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "keyNameProductsInBasket": () => (/* binding */ keyNameProductsInBasket),
/* harmony export */   "renderGoodsToBasket": () => (/* binding */ renderGoodsToBasket)
/* harmony export */ });
...
/* harmony import */ var _rendering_goods_to_favourite_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./rendering-goods-to-favourite.js */ "./src/js/rendering-goods-to-favourite.js");
...
const basketStore = (0,_util_js__WEBPACK_IMPORTED_MODULE_0__.getProducts)(keyNameProductsInBasket);

if (basketWithoutGoods) {
  (0,_util_js__WEBPACK_IMPORTED_MODULE_0__.changeEmptyBlockVisibility)(basketStore, basketPage)
}

// Записываем кол-во товара
(0,_util_js__WEBPACK_IMPORTED_MODULE_0__.checkQuantityGoods)(basketStore, countGoodsInBasket);
...
const onAddProductToBasket = (evt) => {
  ...
  if (evt.target.hasAttribute('data-product-to-basket')) {
    ...
    const result = (0,_util_js__WEBPACK_IMPORTED_MODULE_0__.putProducts)(goodInfo.id, keyNameProductsInBasket);
    ...
    (0,_util_js__WEBPACK_IMPORTED_MODULE_0__.checkQuantityGoods)(quantityGoods, countGoodsInBasket)
  }
  ...
  if (basketSection) {
    if (evt.target.hasAttribute('data-product-in-basket-delete')) {
      ...
      goodsSumPrice.textContent = recalculationSumPrice(_script_js__WEBPACK_IMPORTED_MODULE_1__.mockJetSkiData, basketStore);
...
const renderGoodsToBasket = (products) => {
  ...
  const favouritesStore = (0,_util_js__WEBPACK_IMPORTED_MODULE_0__.getProducts)(_rendering_goods_to_favourite_js__WEBPACK_IMPORTED_MODULE_2__.keyNameProductsInFavourite);
  ...
  if (goodsListInBasket) {
    ...
    products.forEach(good => {
      ...
      if (basketStore.find(goodInBasket => goodInBasket === good.id)) {
        ...
        (0,_util_js__WEBPACK_IMPORTED_MODULE_0__.checkSimilarGoodsInFavourite)(favouritesStore, basketGoodItem, good);
...
/***/ "./src/js/rendering-goods-to-catalog.js":
/*!**********************************************!*\
  !*** ./src/js/rendering-goods-to-catalog.js ***!
  \**********************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "elementsToShow": () => (/* binding */ elementsToShow),
/* harmony export */   "renderGoodsToCatalog": () => (/* binding */ renderGoodsToCatalog),
/* harmony export */   "renderPagination": () => (/* binding */ renderPagination)
/* harmony export */ });
/* harmony import */ var _good_availability_modal_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./good-availability-modal.js */ "./src/js/good-availability-modal.js");
/* harmony import */ var _util_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./util.js */ "./src/js/util.js");
/* harmony import */ var _rendering_goods_to_basket_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./rendering-goods-to-basket.js */ "./src/js/rendering-goods-to-basket.js");
/* harmony import */ var _rendering_goods_to_favourite_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./rendering-goods-to-favourite.js */ "./src/js/rendering-goods-to-favourite.js");
/* harmony import */ var _select_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./select.js */ "./src/js/select.js");
...
const renderGoodsToCatalog = (products, countGoodsToRender, page) => {
  ...
  if (pageCatalog) {
    ...
    if (popularGoodsList) {
      ...
      // Достали данные из локального хранилища по избранному товару
      const favouritesStore = (0,_util_js__WEBPACK_IMPORTED_MODULE_1__.getProducts)(_rendering_goods_to_favourite_js__WEBPACK_IMPORTED_MODULE_3__.keyNameProductsInFavourite);

      // Товары в корзине
      const basketStore = (0,_util_js__WEBPACK_IMPORTED_MODULE_1__.getProducts)(_rendering_goods_to_basket_js__WEBPACK_IMPORTED_MODULE_2__.keyNameProductsInBasket);
      ...
      goodsData.forEach(good => {
        ...
        // // =================
        // Один и тот же товар, в корзине, избранном и каталоге
        (0,_util_js__WEBPACK_IMPORTED_MODULE_1__.checkSimilarGoodsInFavourite)(favouritesStore, goodItem, good);

        // // Работа с товарами из корзины
        // // =================
        // Один и тот же товар, в корзине, избранном и каталоге
        (0,_util_js__WEBPACK_IMPORTED_MODULE_1__.checkSimilarGoodsInBasket)(basketStore, goodItem, good);
        ...
        if (!good.availability === true) {
          ...
          notificationGoodAvailability.addEventListener('click', _good_availability_modal_js__WEBPACK_IMPORTED_MODULE_0__.onOpenNotificationGoodAvailability);
        } else {
        ...
        if (window.matchMedia('screen and (min-width: 768px)').matches) {
          ...
          switch (selectedTypeOfSort.dataset.sortSelectItem) {
            case 'По полулярности':
              renderGoodsToCatalog(_script_js__WEBPACK_IMPORTED_MODULE_5__.mockJetSkiData, elementsToShow, currentPage);
              break
            case 'Сначала дешевле':
              const CheapGoodsArr = (0,_select_js__WEBPACK_IMPORTED_MODULE_4__.sortGoodsCheapFirst)(_script_js__WEBPACK_IMPORTED_MODULE_5__.mockJetSkiData);
              renderGoodsToCatalog(CheapGoodsArr, elementsToShow, currentPage);
              break
            case 'Сначала дороже':
              const expensiveGoodsArr = (0,_select_js__WEBPACK_IMPORTED_MODULE_4__.sortGoodsExpensiveFirst)(_script_js__WEBPACK_IMPORTED_MODULE_5__.mockJetSkiData);
              renderGoodsToCatalog(expensiveGoodsArr, elementsToShow, currentPage);
              break
            case 'Высокий рейтинг':
              const highRatingGoodsArr = (0,_select_js__WEBPACK_IMPORTED_MODULE_4__.sortGoodsRating)(_script_js__WEBPACK_IMPORTED_MODULE_5__.mockJetSkiData);
...
/***/ "./src/js/rendering-goods-to-favourite.js":
/*!************************************************!*\
  !*** ./src/js/rendering-goods-to-favourite.js ***!
  \************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "keyNameProductsInFavourite": () => (/* binding */ keyNameProductsInFavourite),
/* harmony export */   "renderGoodsToFavourite": () => (/* binding */ renderGoodsToFavourite)
/* harmony export */ });
/* harmony import */ var _util_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./util.js */ "./src/js/util.js");
/* harmony import */ var _good_availability_modal_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./good-availability-modal.js */ "./src/js/good-availability-modal.js");
...
const amountGoodsInFavourite = (0,_util_js__WEBPACK_IMPORTED_MODULE_0__.getProducts)(keyNameProductsInFavourite);

if (favouritesWithoutGoods) {
  (0,_util_js__WEBPACK_IMPORTED_MODULE_0__.changeEmptyBlockVisibility)(amountGoodsInFavourite, favouriteSection)
}

// Записываем кол-во товара
(0,_util_js__WEBPACK_IMPORTED_MODULE_0__.checkQuantityGoods)(amountGoodsInFavourite, countGoodsInFavourite);
...
const onAddProductToFavourite = (evt) => {
  if (evt.target.hasAttribute('data-product-to-favourites')) {
    ...
    if (goodsListInFavourites) {
      ...
      const favouriteStore = (0,_util_js__WEBPACK_IMPORTED_MODULE_0__.getProducts)(keyNameProductsInFavourite);
      ...
      (0,_util_js__WEBPACK_IMPORTED_MODULE_0__.checkQuantityGoods)(favouriteStore, countGoodsInFavourite);

      if (favouritesWithoutGoods) {
        (0,_util_js__WEBPACK_IMPORTED_MODULE_0__.changeEmptyBlockVisibility)(favouriteStore, favouriteSection)
      }
      ...
      const result = (0,_util_js__WEBPACK_IMPORTED_MODULE_0__.putProducts)(goodInfo.id, keyNameProductsInFavourite)
      let quantityGoods = result.products;
      ...
      // Записываем кол-во товара
      (0,_util_js__WEBPACK_IMPORTED_MODULE_0__.checkQuantityGoods)(quantityGoods, countGoodsInFavourite);
    }
  }
}
...
function renderGoodsToFavourite(products) {
  ...
  // Получаем данные из localStorage с id товарами, которые нужно отрисовать на странице
  const localStorageFavourite = (0,_util_js__WEBPACK_IMPORTED_MODULE_0__.getProducts)(keyNameProductsInFavourite);

  //  Получаем данные из localStorage, которые находятся в корзине
  const basketStore = (0,_util_js__WEBPACK_IMPORTED_MODULE_0__.getProducts)('productsInBasket');
  ...
  if (goodsListInFavourites) {
    ...
    products.forEach((good) => {
      ...
      if (localStorageFavourite.find(goodInFavourite => goodInFavourite === good.id)) {
        ...
        // Один и тот же товар, в корзине, избранном и каталоге
        (0,_util_js__WEBPACK_IMPORTED_MODULE_0__.checkSimilarGoodsInBasket)(basketStore, favouriteGoodItem, good);
        ...
        if (!good.availability === true) {
          ...
          // Вешаем обработчик клика.
          // Показ - уведомления о наличии товара
          notificationGoodAvailability.addEventListener('click', _good_availability_modal_js__WEBPACK_IMPORTED_MODULE_1__.onOpenNotificationGoodAvailability);
        }
...
/***/ "./src/js/rendering-goods-to-product-checkout.js":
/*!*******************************************************!*\
  !*** ./src/js/rendering-goods-to-product-checkout.js ***!
  \*******************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "renderGoodsToProductCheckout": () => (/* binding */ renderGoodsToProductCheckout)
/* harmony export */ });
/* harmony import */ var _util_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./util.js */ "./src/js/util.js");
/* harmony import */ var _rendering_goods_to_basket_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./rendering-goods-to-basket.js */ "./src/js/rendering-goods-to-basket.js");
...
const renderGoodsToProductCheckout = (goods) => {
  if (productCheckoutPage) {
    ...
    const basketStore = (0,_util_js__WEBPACK_IMPORTED_MODULE_0__.getProducts)(_rendering_goods_to_basket_js__WEBPACK_IMPORTED_MODULE_1__.keyNameProductsInBasket);
...
/***/ "./src/js/rendering-product-card.js":
/*!******************************************!*\
  !*** ./src/js/rendering-product-card.js ***!
  \******************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _util_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./util.js */ "./src/js/util.js");
/* harmony import */ var _rendering_goods_to_favourite_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./rendering-goods-to-favourite.js */ "./src/js/rendering-goods-to-favourite.js");
/* harmony import */ var _show_more_product_characteristic_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./show-more-product-characteristic.js */ "./src/js/show-more-product-characteristic.js");
...
const onChangeFavoriteProducts = (evt) => {
  ...
  (0,_util_js__WEBPACK_IMPORTED_MODULE_0__.putProducts)(goodId, _rendering_goods_to_favourite_js__WEBPACK_IMPORTED_MODULE_1__.keyNameProductsInFavourite);

  // Количество товаров в избранном при загрузке/обновлении страницы
  const amountGoodsInFavourite = (0,_util_js__WEBPACK_IMPORTED_MODULE_0__.getProducts)(_rendering_goods_to_favourite_js__WEBPACK_IMPORTED_MODULE_1__.keyNameProductsInFavourite);
...
const fillProductCardData = (selectedGood) => {
  ...
  // Работа с товарами из избранного
  // =================
  const favouriteStore = (0,_util_js__WEBPACK_IMPORTED_MODULE_0__.getProducts)(_rendering_goods_to_favourite_js__WEBPACK_IMPORTED_MODULE_1__.keyNameProductsInFavourite);
...
const renderProductCard = (goods) => {
  ...
  if (productCardPage) {
    ...
    if (showMoreProductCharacteristicBtn) {
      showMoreProductCharacteristicBtn.addEventListener('click', _show_more_product_characteristic_js__WEBPACK_IMPORTED_MODULE_2__.onShowMoreProductCharacteristic)
    }
  }
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "mockJetSkiData": () => (/* binding */ mockJetSkiData)
/* harmony export */ });
...
/* harmony import */ var _modal_login_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modal-login.js */ "./src/js/modal-login.js");
/* harmony import */ var _good_availability_modal_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./good-availability-modal.js */ "./src/js/good-availability-modal.js");
/* harmony import */ var _description_issue_modal_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./description-issue-modal.js */ "./src/js/description-issue-modal.js");
/* harmony import */ var _rendering_goods_to_basket_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./rendering-goods-to-basket.js */ "./src/js/rendering-goods-to-basket.js");
/* harmony import */ var _rendering_goods_to_favourite_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./rendering-goods-to-favourite.js */ "./src/js/rendering-goods-to-favourite.js");
/* harmony import */ var _rendering_goods_to_product_checkout_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./rendering-goods-to-product-checkout.js */ "./src/js/rendering-goods-to-product-checkout.js");
/* harmony import */ var _rendering_goods_to_catalog_js__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./rendering-goods-to-catalog.js */ "./src/js/rendering-goods-to-catalog.js");
/* harmony import */ var _rendering_product_card_js__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./rendering-product-card.js */ "./src/js/rendering-product-card.js");
/* harmony import */ var _show_more_product_characteristic_js__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./show-more-product-characteristic.js */ "./src/js/show-more-product-characteristic.js");
/* harmony import */ var _appear_delete_btn_input_js__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./appear-delete-btn-input.js */ "./src/js/appear-delete-btn-input.js");
/* harmony import */ var _comment_accordion_js__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./comment-accordion.js */ "./src/js/comment-accordion.js");
/* harmony import */ var _show_more_product_filters_js__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./show-more-product-filters.js */ "./src/js/show-more-product-filters.js");
/* harmony import */ var _server_api_js__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./server-api.js */ "./src/js/server-api.js");
/* harmony import */ var _product_checkout_map_js__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./product-checkout-map.js */ "./src/js/product-checkout-map.js");
/* harmony import */ var _textarea_autoresize_js__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./textarea-autoresize.js */ "./src/js/textarea-autoresize.js");
/* harmony import */ var _vendor_jquery_3_6_3_slim_min_js__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./vendor/jquery-3.6.3.slim.min.js */ "./src/js/vendor/jquery-3.6.3.slim.min.js");
/* harmony import */ var _vendor_jquery_rateyo_js__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./vendor/jquery.rateyo.js */ "./src/js/vendor/jquery.rateyo.js");
...
const renderCatalog = () => {
  ...
  (0,_rendering_goods_to_catalog_js__WEBPACK_IMPORTED_MODULE_16__.renderGoodsToCatalog)(mockJetSkiData, _rendering_goods_to_catalog_js__WEBPACK_IMPORTED_MODULE_16__.elementsToShow, _rendering_goods_to_catalog_js__WEBPACK_IMPORTED_MODULE_16__.currentPage);
  (0,_rendering_goods_to_catalog_js__WEBPACK_IMPORTED_MODULE_16__.renderPagination)(mockJetSkiData, _rendering_goods_to_catalog_js__WEBPACK_IMPORTED_MODULE_16__.elementsToShow);

  (0,_rendering_goods_to_basket_js__WEBPACK_IMPORTED_MODULE_13__.renderGoodsToBasket)(mockJetSkiData);
  (0,_rendering_goods_to_favourite_js__WEBPACK_IMPORTED_MODULE_14__.renderGoodsToFavourite)(mockJetSkiData);
  (0,_rendering_product_card_js__WEBPACK_IMPORTED_MODULE_17__.renderProductCard)(mockJetSkiData);

  (0,_rendering_goods_to_product_checkout_js__WEBPACK_IMPORTED_MODULE_15__.renderGoodsToProductCheckout)(mockJetSkiData);
  ...
  if (showMoreProductCharacteristicBtn) {
    showMoreProductCharacteristicBtn.addEventListener('click', _show_more_product_characteristic_js__WEBPACK_IMPORTED_MODULE_18__.onShowMoreProductCharacteristic)
  }
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "clearGoods": () => (/* binding */ clearGoods),
/* harmony export */   "sortGoodsCheapFirst": () => (/* binding */ sortGoodsCheapFirst),
/* harmony export */   "sortGoodsExpensiveFirst": () => (/* binding */ sortGoodsExpensiveFirst),
/* harmony export */   "sortGoodsRating": () => (/* binding */ sortGoodsRating)
/* harmony export */ });
/* harmony import */ var _rendering_goods_to_catalog_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./rendering-goods-to-catalog.js */ "./src/js/rendering-goods-to-catalog.js");
/* harmony import */ var _script_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./script.js */ "./src/js/script.js");
// import { mockJetSkiData } from "./util.js";
        ...
        if (evt.target.matches('[data-sort-select-item]')) {
          ...
          switch (selectItemValue) {
            case 'По полулярности':
              ...
              (0,_rendering_goods_to_catalog_js__WEBPACK_IMPORTED_MODULE_0__.renderGoodsToCatalog)(_script_js__WEBPACK_IMPORTED_MODULE_1__.mockJetSkiData, _rendering_goods_to_catalog_js__WEBPACK_IMPORTED_MODULE_0__.elementsToShow, _rendering_goods_to_catalog_js__WEBPACK_IMPORTED_MODULE_0__.currentPage)
              break
            ...
            case 'Сначала дешевле':
              ...
              clearGoods(pageCatalog);
              (0,_rendering_goods_to_catalog_js__WEBPACK_IMPORTED_MODULE_0__.renderGoodsToCatalog)(sortGoodsCheapFirst(_script_js__WEBPACK_IMPORTED_MODULE_1__.mockJetSkiData), _rendering_goods_to_catalog_js__WEBPACK_IMPORTED_MODULE_0__.elementsToShow, _rendering_goods_to_catalog_js__WEBPACK_IMPORTED_MODULE_0__.currentPage)
              break
            ...
            case 'Сначала дороже':
              ...
              clearGoods(pageCatalog);
              (0,_rendering_goods_to_catalog_js__WEBPACK_IMPORTED_MODULE_0__.renderGoodsToCatalog)(sortGoodsExpensiveFirst(_script_js__WEBPACK_IMPORTED_MODULE_1__.mockJetSkiData), _rendering_goods_to_catalog_js__WEBPACK_IMPORTED_MODULE_0__.elementsToShow, _rendering_goods_to_catalog_js__WEBPACK_IMPORTED_MODULE_0__.currentPage)
              break
            ...
            case 'Высокий рейтинг':
              ...
              clearGoods(pageCatalog);
              (0,_rendering_goods_to_catalog_js__WEBPACK_IMPORTED_MODULE_0__.renderGoodsToCatalog)(sortGoodsRating(_script_js__WEBPACK_IMPORTED_MODULE_1__.mockJetSkiData), _rendering_goods_to_catalog_js__WEBPACK_IMPORTED_MODULE_0__.elementsToShow, _rendering_goods_to_catalog_js__WEBPACK_IMPORTED_MODULE_0__.currentPage)
              break
          }
        }
      }
...
/***/ "./src/js/show-more-product-characteristic.js":
/*!****************************************************!*\
  !*** ./src/js/show-more-product-characteristic.js ***!
  \****************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "onShowMoreProductCharacteristic": () => (/* binding */ onShowMoreProductCharacteristic)
/* harmony export */ });
// Кнопка для навешиавания обработчика
// const showMoreProductCharacteristicBtn = document.querySelector('[data-show-more-product-characteristic]');
...
/***/ "./src/js/show-more-product-filters.js":
/*!*********************************************!*\
  !*** ./src/js/show-more-product-filters.js ***!
  \*********************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _rendering_goods_to_catalog_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./rendering-goods-to-catalog.js */ "./src/js/rendering-goods-to-catalog.js");
      ...
      if (evt.target.matches('[data-sort-popup-item]')) {
        ...
        switch (selectItemValue) {
          case 'По полулярности':
            ...
            (0,_select_js__WEBPACK_IMPORTED_MODULE_0__.clearGoods)(pageCatalog);
            (0,_rendering_goods_to_catalog_js__WEBPACK_IMPORTED_MODULE_1__.renderGoodsToCatalog)(_script_js__WEBPACK_IMPORTED_MODULE_2__.mockJetSkiData, _rendering_goods_to_catalog_js__WEBPACK_IMPORTED_MODULE_1__.elementsToShow, _rendering_goods_to_catalog_js__WEBPACK_IMPORTED_MODULE_1__.currentPage)
            break
          ...
          case 'Сначала дешевле':
            ...
            (0,_select_js__WEBPACK_IMPORTED_MODULE_0__.clearGoods)(pageCatalog);
            (0,_rendering_goods_to_catalog_js__WEBPACK_IMPORTED_MODULE_1__.renderGoodsToCatalog)((0,_select_js__WEBPACK_IMPORTED_MODULE_0__.sortGoodsCheapFirst)(_script_js__WEBPACK_IMPORTED_MODULE_2__.mockJetSkiData), _rendering_goods_to_catalog_js__WEBPACK_IMPORTED_MODULE_1__.elementsToShow, _rendering_goods_to_catalog_js__WEBPACK_IMPORTED_MODULE_1__.currentPage)
            break
          ...
          case 'Сначала дороже':
            ...
            (0,_select_js__WEBPACK_IMPORTED_MODULE_0__.clearGoods)(pageCatalog);
            console.log((0,_select_js__WEBPACK_IMPORTED_MODULE_0__.sortGoodsExpensiveFirst)(_script_js__WEBPACK_IMPORTED_MODULE_2__.mockJetSkiData))
            ;(0,_rendering_goods_to_catalog_js__WEBPACK_IMPORTED_MODULE_1__.renderGoodsToCatalog)((0,_select_js__WEBPACK_IMPORTED_MODULE_0__.sortGoodsExpensiveFirst)(_script_js__WEBPACK_IMPORTED_MODULE_2__.mockJetSkiData), _rendering_goods_to_catalog_js__WEBPACK_IMPORTED_MODULE_1__.elementsToShow, _rendering_goods_to_catalog_js__WEBPACK_IMPORTED_MODULE_1__.currentPage)
            break
          ...
          case 'Высокий рейтинг':
            ...
            (0,_select_js__WEBPACK_IMPORTED_MODULE_0__.clearGoods)(pageCatalog);
            (0,_rendering_goods_to_catalog_js__WEBPACK_IMPORTED_MODULE_1__.renderGoodsToCatalog)((0,_select_js__WEBPACK_IMPORTED_MODULE_0__.sortGoodsRating)(_script_js__WEBPACK_IMPORTED_MODULE_2__.mockJetSkiData), _rendering_goods_to_catalog_js__WEBPACK_IMPORTED_MODULE_1__.elementsToShow, _rendering_goods_to_catalog_js__WEBPACK_IMPORTED_MODULE_1__.currentPage)
            break
        }
      }
    }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "changeEmptyBlockVisibility": () => (/* binding */ changeEmptyBlockVisibility),
/* harmony export */   "checkQuantityGoods": () => (/* binding */ checkQuantityGoods),
/* harmony export */   "checkSimilarGoodsInBasket": () => (/* binding */ checkSimilarGoodsInBasket),
/* harmony export */   "checkSimilarGoodsInFavourite": () => (/* binding */ checkSimilarGoodsInFavourite),
...
/***/ "./src/js/vendor/jquery-3.6.3.slim.min.js":
/*!************************************************!*\
  !*** ./src/js/vendor/jquery-3.6.3.slim.min.js ***!
  \************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
